...
Write-Host "  1. Abre OBS. Docks -> Custom Browser Docks -> agrega 'Confluence Stream Info' (http://localhost:7773) y 'Confluence Chat' (http://localhost:7773/currents.html)"
Write-Host "  2. Arranca Confluence una primera vez con el boton Restart de este mismo dock (obs-autostart.lua ya no se usa)"
Write-Host ""
